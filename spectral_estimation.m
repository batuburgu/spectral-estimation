...
% % Plot for Signal 1 with SNR = -10 dB
% figure(9);
% plot(welchs_freq_domain_3, welchs_power_1_m10dB,'Color','black');
% hold on
% plot(-welchs_freq_domain_3, welchs_power_1_m10dB,'Color','black');
% title('Welchs Method Result for Signal 1 ( sin(2 * pi * 100 * t) ) with SNR = -10dB');
% xlabel('Frequency (Hz)');
...
% % Plot for Signal 2 with SNR = -10 dB
% figure(12);
% plot(welchs_freq_domain_6, welchs_power_2_m10dB,'Color','black');
% hold on
% plot(-welchs_freq_domain_6, welchs_power_2_m10dB,'Color','black');
% title('Welchs Method Result for Signal 2 ( sin(2 * pi * 150 * t) ) with SNR = -10dB');
% xlabel('Frequency (Hz)');
...
% Plot for Signal 1 with SNR = +10 dB
figure(13);
plot(blackman_freq_domain_1, blackman_power_1_10dB,'Color','blue');
hold on
plot(-blackman_freq_domain_1, blackman_power_1_10dB,'Color','blue');
title('Welchs Method Result for Signal 1 ( sin(2 * pi * 100 * t) ) with SNR = 10dB');
xlabel('Frequency (Hz)');
...
% Plot for Signal 1 with SNR = 0 dB
figure(14);
plot(blackman_freq_domain_2, blackman_power_1_0dB,'Color','red');
hold on
plot(-blackman_freq_domain_2, blackman_power_1_0dB,'Color','red');
title('Welchs Method Result for Signal 1 ( sin(2 * pi * 100 * t) ) with SNR = 0dB');
xlabel('Frequency (Hz)');
...
% Plot for Signal 2 with SNR = 10 dB
figure(16);
plot(blackman_freq_domain_4, blackman_power_2_10dB,'Color','blue');
hold on
plot(-blackman_freq_domain_4, blackman_power_2_10dB,'Color','blue');
title('Welchs Method Result for Signal 2 ( sin(2 * pi * 150 * t) ) with SNR = 10dB');
xlabel('Frequency (Hz)');
...
% Plot for Signal 2 with SNR = 0 dB
figure(17);
plot(blackman_freq_domain_5, blackman_power_2_0dB,'Color','red');
hold on
plot(-blackman_freq_domain_5, blackman_power_2_0dB,'Color','red');
title('Welchs Method Result for Signal 2 ( sin(2 * pi * 150 * t) ) with SNR = 0dB');
xlabel('Frequency (Hz)');
